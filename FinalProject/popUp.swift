    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                ...
                TextField("Search here", text: /*@START_MENU_TOKEN@*//*@PLACEHOLDER=Value@*/.constant("")/*@END_MENU_TOKEN@*/)
                    .padding()
                    .overlay(RoundedRectangle(cornerRadius:9).stroke(Color.gray, lineWidth: 1))
                    .padding(.all)
                VStack {
                    HStack{
                        ZStack{
